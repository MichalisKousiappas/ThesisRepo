...
int main (int argc,char *argv[])
{
	...
	sprintf(serverIP2, "tcp://192.168.10.11:%s", serverPort2);
	sprintf(serverIP3, "tcp://192.168.10.11:%s", serverPort3);
	...
	void *reqServer2= zmq_socket(context, ZMQ_REQ);
	void *reqServer3 = zmq_socket(context, ZMQ_REQ);
